...
wget -O "$OUT/spring-core.jar" "https://repo1.maven.org/maven2/org/springframework/spring-core/5.3.19/spring-core-5.3.19.jar"

ALL_JARS="spring-boot.jar spring-boot-loader.jar spring-core.jar"
